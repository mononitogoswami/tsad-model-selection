...
DGHL_PARAM_GRID = {
    ...
    'z_size_up' : [5], 
    'z_iters' : [25, 100], # Number of iteration in the Langevyn dynamics inference formula. [5, 25, 100] -- more the better and slower. Linear time dependence. 
...
LSTMVAE_PARAM_GRID = {
    'window_size': [64], 
    'window_step': [64],
    'hidden_size' : [512, 256], # hidden_size – The number of features in the hidden state h
    'latent_size' : [256, 128], # Size of the latent z 
    'num_layers' : [4], # Number of recurrent layers. Setting num_layers=2 would mean stacking two LSTMs together to form a stacked LSTM.
    'noise_std' : [0.001],  
    'random_seed' : [1], 
    'device': [None]
}
