    ...
    for i in trange(n_repeats):
        for j, anomaly_params in enumerate(
            ...
            for batch in dataloader:
                ...
                entity_scores[step:(step +
                                    batch_size), :, :] = batch_anomaly_score
                step += batch_size
            ...
            PREDICTIONS[
                f'anomalysizes_type_{anomaly_type}_rep_{i}_{j}'] = anomaly_sizes
            PREDICTIONS[
                f'anomalylabels_type_{anomaly_type}_rep_{i}_{j}'] = anomaly_labels
            PREDICTIONS[
                f'entityscores_type_{anomaly_type}_rep_{i}_{j}'] = entity_scores
