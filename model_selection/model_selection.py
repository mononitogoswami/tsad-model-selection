...
class RankModels(object):
    def __init__(
        ...
        trained_model_path:
        str = r'/home/ubuntu/efs/trained_models/',  # NOTE: Should be shared between Trainer and RankModels Class
        downsampling:
        int = 10,  # NOTE: Should be shared between Trainer and RankModels Class
        min_length:
        int = 256,  # NOTE: Should be shared between Trainer and RankModels Class
        root_dir:
        str = '/home/ubuntu/datasets/',  # NOTE: Should be shared between Trainer and RankModels Class
        normalize:
        bool = True,  # NOTE: Should be shared between Trainer and RankModels Class
        verbose: bool = False):
