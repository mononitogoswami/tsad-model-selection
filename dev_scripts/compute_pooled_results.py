...
evaluation_params = [
    {
        ...
        'data_family': [
            'Acceleration Sensor Data', 'Air Temperature',
            'Atrial Blood Pressure (ABP)',
            'Electrocardiogram (ECG) Arrhythmia', 'Gait',
            'Insect Electrical Penetration Graph (EPG)', 'NASA Data',
            'Power Demand', 'Respiration Rate (RESP)'
        ],
